...
for i in range(num_subsets):
    ...
    if subset_proj.tof:
        subset_att_op = parallelproj.operators.TOFNonTOFElementwiseMultiplicationOperator(
...
pet_subset_linop_seq = parallelproj.operators.LinearOperatorSequence(pet_subset_linop_seq)
